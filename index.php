            ...
            <header class="jumbotron jumbotron-fluid" id="home">
                <div class="container outer">
                    ...
                    <p style="font-style: italic;">"The late stages in life can be significant and emotional. It allows families to come together in special
                        moments. Focus on giving loving care and attempt to make their loved ones as comfortable and secure
                    ...
                    <p>We are committed to provide unmatched services for the elderly in the comfort of their own home, retirement
                        home or hospital. We are committed to provide care for the elderly by simply working with them like
                        our own family.
                    </p>
                ...
                <div class="container card-deck">
                    <section class="services card card-outline-info mb-3 " id="ourServices">
                        ...
                        <div class="card-block">
                            <ul class="card-text">
                                <li>Assist loved ones in the regimens prescribed by their physician</li>
                                <li>Offer supportive management such as</li>
                            </ul>
                        </div>
                    </section>

                    <section class="services card card-outline-info mb-3 " id="homeServices">
                        <header class="card-header card-info text-white">
                            <h2 class="mt-2">Home Services</h2>
                        </header>
                        <div class="card-block">
                            <ul class="card-text">
                                ...
                                <li>Run errands and incidental transportation</li>
                                <li>Pet care</li>
                            </ul>
                        </div>
                    </section>

                    <section class="services card card-outline-info mb-3 " id="companionCare">
                        <header class="card-header card-info text-white">
                            <h2 class="mt-2">Companion Care</h2>
                        </header>
                        <div class="card-block">
                            <ul class="card-text">
                                <li>Conversion</li>
                                <li>Taking walks</li>
                                <li>Playing cards, puzzle and games</li>
                                <li>Going out for meal, movie, shopping</li>
                                <li>Attend religious services</li>
                                <li>Drive to park, beach for a scenic walk</li>
                            </ul>
                        </div>
                    </section>
                </div>
